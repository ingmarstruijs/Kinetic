...
This document describes the smart reminder chips, reminder time defaults, notes list privacy, connection-aware task delegation, and the on-device suggestion engine in the adult app.
