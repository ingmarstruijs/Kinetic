        ...
        <ul class="tasks">
          ${y.length===0?'<li class="hint">No open tasks</li>':y.map(s=>`
              <li>
                ...
                <span class="title">${g(s.title)}</span>
              </li>`).join("")}
        </ul>
        <div class="add-row">
