...
class ProposalAnalyzer {
  ...
  ///
  /// [myLinkId] is used to dedup against proposals already sent by this
  /// link device in the last [_deduplicationDays] days.
  Future<List<PersonalTaskRow>> findCandidates(String myLinkId) async {
    if (myLinkId.isEmpty) return [];
    ...
    // 3. Titles already proposed by this device recently (dedup).
