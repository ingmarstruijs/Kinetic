...
| File | Role |
|------|------|
| `logo-adult.svg` / `logo-kids.svg` | Vector masters (edit these) |
...
```bash
cd apps/adult && dart run flutter_launcher_icons
...
```bash
cp brand/logo-adult-1024-rounded.png apps/adult/assets/icons/app_icon.png
